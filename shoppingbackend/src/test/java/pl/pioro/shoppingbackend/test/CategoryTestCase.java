...
public class CategoryTestCase {
	...
	public void testGetCategory() {
		...
		assertEquals("Succesfully fetched a single category from the table", "Mobile" ,category.getName());
	}*/
	...
	*/
	...
	public void testCRUDCategory() {
		...
		category.setDescription("This is a description for palmtop");
		category.setImageURL("CAT_1575.png");
